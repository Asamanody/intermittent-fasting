...
class HeightDialog : SheetDialogBinding() {
    ...
    override fun onCreateView(
        ...
        return binding<FragmentNumberDialogBinding>(
            ...
            DialogTitle.text = getString(R.string.enterheight)
            numberPicker.value = args.height

            go.setOnClickListener {
                setNavigationResult(numberPicker.value.toString(), "height")
