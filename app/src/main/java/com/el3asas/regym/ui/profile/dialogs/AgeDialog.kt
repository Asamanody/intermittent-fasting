...
class AgeDialog : SheetDialogBinding() {
    ...
    override fun onCreateView(
        ...
        return binding<FragmentNumberDialogBinding>(
            ...
            DialogTitle.text=getString(R.string.enterage)
            numberPicker.value = args.age
            go.setOnClickListener {
                this@AgeDialog.setNavigationResult(numberPicker.value.toString(), "age")
